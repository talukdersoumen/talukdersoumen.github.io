...
const Home = () => {
  return (
    <div className="HomeBody flex flex-col justify-start items-center gap-4 relative h-screen w-full text-white bg-black p-12 font-bold bg-cover bg-no-repeat">
